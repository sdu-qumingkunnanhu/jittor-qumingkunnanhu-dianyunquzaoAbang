...
from src.model.ops import patch_based_denoise
...
class CascadePredictor:
    ...
    def denoise_langevin_dynamics(self, pc_noisy):
        with jt.no_grad():
            ...
            x1 = pc_noisy + disp1
            disp2, _ = self.stage2.feature_nets(x1, calculate_commitment_losses=False)
        return x1 + disp2
...
def train_joint(task, resume: bool = False):
    ...
    for epoch in range(start_epoch, joint_epochs + 1):
        ...
        for batch_idx, batch in enumerate(train_loader):
            ...
            x1 = noisy + disp1
            disp2, commitment2 = stage2.feature_nets(x1, calculate_commitment_losses=True)
            x2 = x1 + disp2

            loss1 = calc_cd_like_InfoV2(x1, clean)
            loss2 = calc_cd_like_InfoV2(x2, clean)
